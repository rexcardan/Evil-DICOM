...
namespace EvilDICOM.Core.Helpers
{
    public class TagSorter : IComparer<IDICOMElement>
    {
        ...
        {
            var tagBytes_1 = ConvertToLittleEndian(ByteHelper.HexStringToByteArray(el1.Tag.CompleteID));
            var tagBytes_2 = ConvertToLittleEndian(ByteHelper.HexStringToByteArray(el2.Tag.CompleteID));
