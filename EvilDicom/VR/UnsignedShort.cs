...
namespace EvilDicom
{
    namespace VR
    {
        public class UnsignedShort : AbstractBinaryVR
        {
            public UnsignedShort() { VR = "US"; }

            public new UInt16 Data
            {
                ...
                get { return BitConverter.ToUInt16(ArrayHelper.ReverseArray(base.Data), 0); }
            }
